...
module sbc
   (BRAM_PORTA_1_addr,
    ...
    BRAM_PORTB_rst,
    BRAM_PORTB_we);
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTA_1 ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTA_1, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 128, MEM_WIDTH 64, READ_WRITE_MODE READ_WRITE" *) input [3:0]BRAM_PORTA_1_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTA ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTA, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 128, MEM_WIDTH 64, READ_WRITE_MODE READ_WRITE" *) input [3:0]BRAM_PORTA_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB_1 ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTB_1, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 128, MEM_WIDTH 64, READ_WRITE_MODE READ_WRITE" *) input [3:0]BRAM_PORTB_1_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTB, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 128, MEM_WIDTH 64, READ_WRITE_MODE READ_WRITE" *) input [3:0]BRAM_PORTB_addr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB CLK" *) input BRAM_PORTB_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB DIN" *) input [63:0]BRAM_PORTB_din;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB DOUT" *) output [63:0]BRAM_PORTB_dout;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB WE" *) input [7:0]BRAM_PORTB_we;

  wire [3:0]BRAM_PORTA_1_1_ADDR;
  ...
  assign BRAM_PORTA_1_1_ADDR = BRAM_PORTA_1_addr[3:0];
  ...
  assign BRAM_PORTA_1_DIN = BRAM_PORTA_din[63:0];
  assign BRAM_PORTA_1_EN = BRAM_PORTA_en;
  assign BRAM_PORTA_1_RST = BRAM_PORTA_rst;
  assign BRAM_PORTA_1_WE = BRAM_PORTA_we[7:0];
  assign BRAM_PORTA_1_dout[63:0] = BRAM_PORTA_1_1_DOUT;
  assign BRAM_PORTA_dout[63:0] = BRAM_PORTA_1_DOUT;
  assign BRAM_PORTB_1_1_ADDR = BRAM_PORTB_1_addr[3:0];
  ...
  assign BRAM_PORTB_1_DIN = BRAM_PORTB_din[63:0];
  assign BRAM_PORTB_1_EN = BRAM_PORTB_en;
  assign BRAM_PORTB_1_RST = BRAM_PORTB_rst;
  assign BRAM_PORTB_1_WE = BRAM_PORTB_we[7:0];
  assign BRAM_PORTB_1_dout[63:0] = BRAM_PORTB_1_1_DOUT;
  assign BRAM_PORTB_dout[63:0] = BRAM_PORTB_1_DOUT;
