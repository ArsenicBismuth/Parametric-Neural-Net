...
module ram
   (BRAM_PORTA_addr,
    ...
    BRAM_PORTB_rst,
    BRAM_PORTB_we);
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTA ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTA, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 256, MEM_WIDTH 32" *) input [7:0]BRAM_PORTA_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTB, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 256, MEM_WIDTH 32" *) input [7:0]BRAM_PORTB_addr;
  ...
  assign BRAM_PORTA_1_ADDR = BRAM_PORTA_addr[7:0];
  ...
  assign BRAM_PORTB_1_ADDR = BRAM_PORTB_addr[7:0];
