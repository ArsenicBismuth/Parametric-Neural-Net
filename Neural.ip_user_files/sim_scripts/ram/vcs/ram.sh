...
#
# Generated by Vivado on Thu Dec 13 06:17:16 +0700 2018
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k \
    "$ref_dir/../../../../Neural.srcs/sources_1/bd/ram/ipshared/67d8/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../bd/ram/ip/ram_blk_mem_gen_0_0/sim/ram_blk_mem_gen_0_0.v" \
    "$ref_dir/../../../bd/ram/sim/ram.v" \
  2>&1 | tee -a vlogan.log
